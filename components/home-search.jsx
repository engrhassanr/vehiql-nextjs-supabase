    ...
    <div>
      <form onSubmit={handleTextSearch}>
        <div className="relative flex items-center">
          ...
          {/* Image Search Button */}
          <ClientOnly
            fallback={<div className="absolute right-[100px] w-10 h-10" />}
          >
            <div className="absolute right-[100px]">
              <Camera
                ...
                style={{
                  background: isHydrated && isImageSearchActive ? "black" : "",
                  color: isHydrated && isImageSearchActive ? "white" : "",
                }}
              />
            </div>
          </ClientOnly>
      ...
      <ClientOnly>
        {isHydrated && isImageSearchActive && (
          <div className="mt-4">
